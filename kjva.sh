...
show_help() {
	...
	echo   
	echo    "  [33m-l[0m      list books"
	echo    "  [32m-w[0m      no line wrap"
	echo    "  [32m-W[0m      no line wrap (same as [32m-w[0m)"
	echo    "  [36m-h[0m      show help"
	echo   
	echo    "  Reference types:"
	echo    "      [31m<Book>[0m"
	echo    "          Individual book"
	echo    "      [31m<Book>[0m:[32m<Chapter>[0m"
	echo    "          Individual chapter of a book"
	echo    "      [31m<Book>[0m:[32m<Chapter>[0m:[33m<Verse>[0m[,[33m<Verse>[0m]..."
	echo    "          Individual verse(s) of a specific chapter of a book"
	echo    "      [31m<Book>[0m:[32m<Chapter>[0m-[32m<Chapter>[0m"
	echo    "          Range of chapters in a book"
	echo    "      [31m<Book>[0m:[32m<Chapter>[0m:[33m<Verse>[0m-[33m<Verse>[0m"
	echo    "          Range of verses in a book chapter"
	echo    "      [31m<Book>[0m:[32m<Chapter>[0m:[33m<Verse>[0m-[32m<Chapter>[0m:[33m<Verse>[0m"
	echo    "          Range of chapters and verses in a book"
	echo
	echo    "      /<Search>"
	echo    "          All verses that match a pattern"
	echo    "      [31m<Book>[0m/<Search>"
	echo    "          All verses in a book that match a pattern"
	echo    "      [31m<Book>[0m:[32m<Chapter>[0m/<Search>"
